    ...
    <div class="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm mb-6">
        ...
        <div class="px-6 pb-6 pt-2">
            <div class="pt-4 border-t border-gray-100 flex justify-end gap-2">
                ...
                <button id="btn-laporkan-toko" @click="reportModalOpen = true" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-red-600 bg-red-50 hover:bg-red-100 rounded-lg transition-colors border border-red-100 shadow-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
