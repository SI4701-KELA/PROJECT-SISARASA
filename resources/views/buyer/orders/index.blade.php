                        ...
                        <div class="flex flex-col lg:flex-row gap-6">
                            ...
                            <div class="lg:w-64 flex flex-col justify-between border-t lg:border-t-0 lg:border-l border-gray-50 pt-5 lg:pt-0 lg:pl-6">
                                ...
                                <div class="flex flex-col gap-2">
                                    {{-- Logika Tombol Rating & Ulasan --}}
                                    @if($order->status === 'selesai')
                                        @if($order->review)
                                            {{-- Sudah pernah dinilai / diulas --}}
                                            <span class="w-full inline-flex items-center justify-center gap-1.5 px-4 py-2.5 bg-emerald-50 border border-emerald-100 text-emerald-700 font-extrabold rounded-xl text-xs uppercase tracking-wider">
                                            ...
                                            <button type="button" 
                                                    ...
                                                    class="w-full inline-flex items-center justify-center px-4 py-2.5 bg-gray-50 border border-gray-200 text-gray-600 hover:bg-gray-100 font-bold rounded-xl transition-all duration-200 text-xs shadow-sm cursor-pointer focus:outline-none">
                                                Lihat Ulasan Saya
                                            </button>
                                        @else
                                            ...
                                            <button type="button" 
                                                    ...
                                                    class="w-full inline-flex items-center justify-center gap-1.5 px-4 py-3 bg-[#c04b36] hover:bg-[#a33d2b] text-white font-extrabold rounded-xl transition-all duration-200 text-sm shadow-md shadow-red-100 cursor-pointer focus:outline-none">
